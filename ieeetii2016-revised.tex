...
%\author{Peter~Cooper, Theo~Tryfonas, Tom~Crick and~Alex Marsh}% <-this % stops a space
...
% abstract for ScholarOne:

% Three distinct trends have emerged that have disrupted the dominance of
% privately-owned, combustion car transport in the UK: first, the
% emergence of the electric powertrain as an affordable means of
% transport; second, the rise of new hire models of car ownership;
% third, the rise of `smart city thinking', the concept that increased
% connectivity, data and smart grids can be harnessed to create value,
% especially in transport. We define the combination of the three as the
...
% methodology of workshops, interviews and systems modelling drawing
% upon the UK city of Bristol's {\emph{Smart EV Transport Hub}} project
% to identify concepts that positively combine two or more of these
% three `Opts'.
...
emergence of the electric powertrain as an affordable means of
transport, with the potential to address many of the ‘pump-to-tire’
...
paying for the use of a car per single leg of a journey, also
addressing systematic impact such as residential parking and social
division. Thirdly, the rise of `smart city thinking', the concept that
increased connectivity, data and smart grids can be harnessed to
create value, especially in transport. We define the combination of
the three as the `Tri-Opt' of private transport -- three disruptors
...
upon the UK city of Bristol's {\emph{Smart EV Transport Hub}} project
to identify concepts that positively combine two or more of these
three `Opts'. Subsequently, the use cases are evaluated qualitatively
for their comparative value, and segmentation is undertaken to
...
and they create significant value; thus the `Tri-Opt' notion should be
...
private sector collaboration. It is thus highly recommended that
public-private sector collaboration in private transport -- within a
context of digital innovation -- electric vehicles, smart grids and
mobility as a service model, is subject to further research and
investigation.
\end{abstract}
...
\IEEEPARstart{A}{growing} corpus of research is gathering consensus on
...
% from old caption:
% the dotted line and faded blue correspond to the absence of this
% second reinforcing loop, undermining the system when value is
% predominantly systematic benefits to the city.
