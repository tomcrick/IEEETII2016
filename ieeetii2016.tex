...
\begin{abstract}
Three distinct trends are emerging to shake-up the current dominance
of privately-owned, unconnected, combustion motor car transport in the
UK. The first is the emergence of the electric powertrain for vehicles
as an affordable and mass-marketed means of transport. This carries
with it the potential to address many of the `pump-to-tire'
...
ownership -- the concept of paying for the use of a car per single leg
of a journey. This carries with it the potential to address many of
existing systematic issues: sunk-cost induced car use, residential
parking and social division. For the third, we are witnessing the rise
of `smart city thinking', the concept that increased data and
connectivity within an urban system can be harnessed to create value,
including in transport.

At present there is little academic research exploring the potential
for three-way synergy, despite an emerging evidence base that
combinations of any two are mutually-beneficial. Indeed, real-world
examples of tri-fusions are rare: cars are predominantly
privately-owned, driven by internal combustion engines and very rarely
`connected' in any digital sense. But we are beginning to see
commercial initiatives thriving the overlap, such as the rapid growth
of AutoLib in Paris. This paper thus defines these as the `TriOpt' of
private transport -- three disruptors that should not be considered in
isolation but as interacting levers -- an inflection of the `Energy
Trilemma'.

This paper subscribes to a systems-thinking philosophy, and implements
a mixed methodology of workshops, interviews and systems dynamics
modelling drawn from the UK city of Bristol’s `Smart EV Transport Hub'
project. The objectives are to identify concepts that positively
combine two or more of these three `Opts' and understand the barriers
and enablers to these concepts. Subsequently, the use cases are
evaluated qualitatively for their comparative value, and segmentation
is undertaken to characterise and generalise groups of concepts to
inform recommended stakeholder actions. 

In conclusion it is demonstrated that these synergistic overlaps are
in fact numerous, combine to create significant value in combination
and so this `TriOpt' notion should be explored further. However, we
concede the synergistic overlaps may be more significant in overlaps
that include Smart Cities and Digital Innovation, and
Mobility-as-a-Service models, than Electric Vehicles; rather than a
landscape of equal importance as originally hypothesised. Use cases
our data highlights as being of the greatest value are those that the
current literature base has explored the least, and can be
characterised as requiring significant public and private sector
collaboration. As such it is strongly recommended that public-private
sector collaboration in private transport, within a context of digital
innovation, electric vehicles and mobility as a service model, is
