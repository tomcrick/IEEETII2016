...
% as per SOSE2015 paper...
\author{Peter~Cooper, Tom~Crick and~Theo~Tryfonas}% <-this % stops a space
...
{Shell \MakeLowercase{\textit{Cooper et al.}}: Smart Data-Harnessing for Financial Value in Short-Term Hire Electric Car Schemes}
...
\IEEEPARstart{T}{he} last decade has demonstrated the current Western
